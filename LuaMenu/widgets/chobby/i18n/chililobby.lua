return {
	...
	en = {
		...
		save_preset_tooltip = "Save this replay's setup (map, AI opponents, start boxes, game options) as a preset. Load it from a battle room's Option Presets menu. Human players are not included.",
