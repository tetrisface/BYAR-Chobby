return {
	...
	en = {
		...
		-- plugins / widgets browser
		plugins_title = "Widgets",
		plugins_disclaimer = "Community widgets. BAR is not responsible for their content.",
		plugins_folder = "Widgets Folder",
		plugins_folder_tooltip = "Open the local folder where installed widgets are stored (opens in file explorer)",
		plugins_contribute = "Contribute",
		...
		plugins_load_failed = "Failed to load widgets: %{error}",
		plugins_unknown_error = "Unknown error",
		plugins_no_match = "No widgets match your search.",
		...
		plugins_update_all_tooltip = "Download updates for all installed widgets that have one available",
		plugins_update_available_notification = "An update is available for %{name}.",
		plugins_updates_available_notification = "Updates are available for %{count} widgets.",
		plugins_auto_update = "Automatically update widgets",
		plugins_auto_update_tooltip = "Automatically update installed community widgets when a newer version is available",
		plugins_details = "Details",
		plugins_homepage = "Homepage",
		plugins_source = "Source",
		plugins_source_tooltip = "Open this widget's source code page (opens in browser)",
		plugins_discord = "Discord",
		plugins_discord_tooltip = "Open this widget's Discord thread (opens in browser)",
		plugins_unknown_widget = "Unknown Widget",
		plugins_unnamed_widget = "Unnamed Widget",
		plugins_by_author = "by %{author}",
		plugins_unknown_author = "Unknown",
		plugins_tags = "Tags: %{tags}",
		plugins_readme_loading = "README is loading or unavailable.",
		plugins_error_invalid_manifest = "Invalid manifest format",
		...
		os_toast_notifications = "Desktop notifications",
		os_toast_notifications_tooltip = "Show a desktop notification when you are rung or your battle starts or ends, while the game window is not focused",
		os_taskbar_flash = "Flashing taskbar app icon",
		os_taskbar_flash_tooltip = "Flash the taskbar icon when you are rung or your battle starts or ends, while the game window is not focused",
		alert_user_rang_you = "%{name} rang you!",
		alert_returned_to_lobby = "Returned to the lobby",
		alert_battle_starting = "Battle is starting!",
		alert_battle_ended = "Battle ended",
